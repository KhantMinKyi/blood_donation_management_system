...
@endauth -->
                    ...
                    <li class="nav-item dropdown nav-item-dropdownlist donor-nav-item-dropdownlist">
                        ...
                        <div class="dropdown-menu donor-navbar-dropdown" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item"
                                href="{{ url('patient/profile/' . auth('patient')->user()->id) }}"><i class="fa fa-user"
                                    aria-hidden="true"></i>Profile</a>

                            <a class="dropdown-item"
                                href="{{ url('patients/' . auth('patient')->user()->id) . '/edit' }}"><i
    ...
    <script>
        ...
        L.marker([{{ auth('patient')->user()->latitude }}, {{ auth('patient')->user()->longitude }}], {
                icon: patientIcon
            })
            .addTo(map)
            .bindPopup('You')
